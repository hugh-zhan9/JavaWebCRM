...
<script type="text/javascript">
	...
	$(function() {
        ...
        $("#remarkDeleteBtn").click(function () {
            $.ajax({
                url:"activity/detailDelte.do",
                data:{"activityId":"${activity.id}"},
                type:"get",
                dataType:"json",
                contentType: "json",
		...
		$("#remarkSaveBtn").click(function () {
            $.ajax({
                ...
                data:{"noteContent":$.trim($("#remark").val()),"activityId":"${activity.id}"},
                type:"get",
                dataType: "json",
                contentType:"json",
                success:function (data) {
                    if(data.success){
                        $("#remark").val("");
                        /*
                                {"success":true/false,"ar":activityRemark对象}
                         */
                        // 展现信息
                        var html = "";
                        html+='<div class="remarkDiv" style="height: 60px;">';
		...
		// 有个很离谱的事情，就是通过这个方法修改之后，数据库中数据仍然存在，但是却查询不出来了。
...
<body>
    ...
    <%--<div class="modal fade" id="editActivityModal" role="dialog">
        <div class="modal-dialog" role="document" style="width: 85%;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" id="saveChange">更新</button>
                </div>
            </div>
        </div>
    </div>--%>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			...
			<button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-minus" id="remarkDeleteBtn"></span> 删除</button>
		</div>
	</div>
	...
	<div style="position: relative; top: 30px; left: 40px;">
		...
		<%--<!-- 备注1 -->
		<div class="remarkDiv" style="height: 60px;" id="detailMessage">
