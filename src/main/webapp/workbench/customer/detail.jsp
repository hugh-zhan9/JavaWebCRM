...
<script type="text/javascript">
	...
	$(function(){
		...
		// 获取交易
		$.ajax({
			url:"customer/queryBoundTran.do",
			data:{"id":"${customer.id}"},
			dataType:"json",
			type:"get",
			contentType:"json",
			success:function (data) {
				...
				$.each(data, function(i,n) {
					html+='<tr>';
					html+='<td><a href="transaction/detail.jsp" style="text-decoration: none;">'+ n.customerId +' - '+ n.name+'</a></td>';
					html+='<td>'+n.money+'</td>';
					html+='<td>'+n.stage+'</td>';
		...
		// 获取联系人
		$.ajax({
			url:"customer/queryBoundContacts.do",
			data:{"id":"${customer.id}"},
			dataType:"json",
			method:"get",
			contentType:"json",
			success:function (data) {
				...
				$.each(data, function(i,n) {
					html+='<tr>';
					html+='<td><a href="contacts/detail?id='+n.id+'" style="text-decoration: none;">'+n.fullname+'</a></td>';
					html+='<td>'+n.email+'</td>';
					html+='<td>'+n.mphone+'</td>';
